...
set "configFile=C:\Windows\System32\inetsrv\config\applicationHost.config"
set "isFTPAccessControlConfigured=0"

rem FTP 접근 제어 설정 확인
findstr /I /C:"<add name=\"FTPAuthorization\" enabled=\"true\"" "%configFile%" >nul 2>nul
if %errorlevel% equ 0 (
    set "isFTPAccessControlConfigured=1"
)


echo [FTP 접근 제어 설정 취약점 진단]
